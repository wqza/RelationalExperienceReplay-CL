...
class SequentialCIFAR100(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyCIFAR100(data_path() + 'CIFAR100', train=True,
        ...
        if self.args.validation:
            ...
            test_dataset = CIFAR100(data_path() + 'CIFAR100', train=False,
    ...
    def get_backbone():
        ...
        # return resnet18(SequentialCIFAR100.N_CLASSES_PER_TASK * SequentialCIFAR100.N_TASKS, num_tasks=SequentialCIFAR100.N_TASKS)
