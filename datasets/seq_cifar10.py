...
from backbone.MetaResNet18 import resnet18
...
class SequentialCIFAR10(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyCIFAR10(data_path() + 'CIFAR10', train=True,
        ...
        if self.args.validation:
            ...
            test_dataset = CIFAR10(data_path() + 'CIFAR10', train=False,
    ...
    def all_trained_dataloader(self):
        transform = self.TRANSFORM
        ...
        train_loader, test_loader = get_all_trained_loaders(train_dataset, test_dataset, self)
    ...
    def get_backbone():
        ...
        # return resnet18(SequentialCIFAR10.N_CLASSES_PER_TASK * SequentialCIFAR10.N_TASKS, num_tasks=SequentialCIFAR10.N_TASKS)
