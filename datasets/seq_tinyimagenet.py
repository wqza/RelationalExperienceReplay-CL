...
class SequentialTinyImagenet(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyTinyImagenet(data_path() + 'TINYIMG',
                                 train=True, download=False, transform=transform)
        if self.args.validation:
            train_dataset, test_dataset = get_train_val(train_dataset,
                                                    test_transform, self.NAME)
        else:
            test_dataset = TinyImagenet(data_path() + 'TINYIMG',
    ...
    @staticmethod
    def get_backbone():
        return resnet18(SequentialTinyImagenet.N_CLASSES_PER_TASK * SequentialTinyImagenet.N_TASKS, num_tasks=SequentialTinyImagenet.N_TASKS*1)
