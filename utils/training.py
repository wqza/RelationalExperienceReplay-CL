...
def train(model: ContinualModel, dataset: ContinualDataset,
    ...
    for t in range(dataset.N_TASKS):
        ...
        model.SEEN_CLASS = (t + 1) * dataset.N_CLASSES_PER_TASK

        model.net.train()
        # continual learning
        train_loader, test_loader = dataset.get_data_loaders()
        # # all data continual learning (all previous data can be achieved)
        # train_loader, test_loader = dataset.all_trained_dataloader()
        ...
        if model.NAME != 'icarl' and model.NAME != 'pnn':
            ...
            fwt, fwt_mask_classes = None, None
    ...
    if hasattr(dataset, 'cls_img_num'):
        print('cls_img_num =', dataset.cls_img_num)
